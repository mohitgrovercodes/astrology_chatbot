...
class Settings(BaseSettings):
    ...
    FAST_LLM_PROVIDER: str = Field(default="google", validation_alias="fast_llm_provider")
    FAST_LLM_MODEL: str = Field(default="gemini-2.5-flash", validation_alias="fast_llm_model")
