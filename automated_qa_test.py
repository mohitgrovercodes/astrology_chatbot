...
TEST_USER_ID = "user001"  # Arjun Kumar from your DB
...
def init():
    ...
    return orchestrator, TEST_USER_ID

def run_test(orchestrator, test, user_id):
...
def main():
    ...
    for test in TESTS:
        result = run_test(orchestrator, test, user_id)
